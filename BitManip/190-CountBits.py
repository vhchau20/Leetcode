...
# ype and should not affect your implementation, as the internal binary 
...
# he signed integer -3 and the output represents the signed integer 
# -1073741825.
